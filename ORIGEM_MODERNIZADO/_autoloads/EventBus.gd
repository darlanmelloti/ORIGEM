...
## Emitido quando o Guardião captura o jogador.
signal guardian_player_caught()

## Emitido quando o Guardião deteta o jogador (alerta na UI).
signal guardian_alert(text: String, duration: float)

## Emitido para forçar o Guardião a entrar em modo perseguição.
signal guardian_chase_forced()
