...
A porta de qualidade deve ser executada por Dev2–Dev6 antes de pedir integração ou após cada atualização regional na branch `integration/r1-r6-sprint1`. O objetivo é impedir que uma entrega regional quebre os contratos, a rota jogável ou o parser Godot.
