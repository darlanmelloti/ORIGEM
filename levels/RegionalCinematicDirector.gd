...
const TAKE_FRAMES: Dictionary = {
	...
	2: {"position": Vector3(-22.0, 4.0, 22.0), "target": Vector3(-16.5, 3.8, 50.0), "fov": 48.0},
	3: {"position": Vector3(-4.5, 3.35, 110.0), "target": Vector3(-4.0, 1.45, 141.0), "fov": 43.0},
	...
	10: {"position": Vector3(-80.5, 13.0, 162.0), "target": Vector3(-88.0, 0.95, 177.0), "fov": 44.0},
	11: {"position": Vector3(27.0, 4.15, 236.0), "target": Vector3(58.0, 0.95, 252.0), "fov": 35.0},
