...
static func continuity_7_to_8(terrain_y: float = 0.0) -> Dictionary:
	...
	return {
		...
		"to_region": 8,
		"handoff_id": "R07_R08",
		"collider_contract": "ColliderCPD2007_R07_R08",
...
static func continuity_8_to_9(terrain_y: float = 0.0) -> Dictionary:
	...
	return {
		...
		"to_region": 9,
		"handoff_id": "R08_R09",
		"collider_contract": "ColliderCPD2007_R08_R09",
		"map_authority": "mapaorigem.webp",
		"physical_handoff": true,
		"handoff_in": start,
		"handoff_out": finish,
...
static func continuity_9_to_10(terrain_y: float = 0.0) -> Dictionary:
	...
	return {
		...
		"to_region": 10,
		"handoff_id": "R09_R10",
		"collider_contract": "ColisaoHandoffR9R10",
		"map_authority": "mapaorigem.webp",
		"physical_handoff": true,
		"handoff_in": start,
		"handoff_out": finish,
...
static func continuity_10_to_11(terrain_y: float = 0.0) -> Dictionary:
	...
	return {
		...
		"to_region": 11,
		"handoff_id": "R10_R11",
		"collider_contract": "ColisaoHandoffCubeR11",
		"map_authority": "mapaorigem.webp",
		"physical_handoff": true,
		"handoff_in": start,
		"handoff_out": finish,
...
static func continuity_11_to_12(terrain_y: float = 0.0) -> Dictionary:
	...
	return {
		...
		"to_region": 12,
		"handoff_id": "R11_R12",
		"collider_contract": "ColisaoHandoffHubR12",
		"map_authority": "mapaorigem.webp",
		"physical_handoff": true,
		"handoff_in": start,
		"handoff_out": finish,
