# CP-D5-520 — Auditoria integrada contínua R1–R6
...
O runtime completo está em `CP-D5-520_RUNTIME.log`. O checksum SHA-256 do relatório e do runtime está em `CP-D5-520_SHA256SUMS.txt`.
