...
## CP-D5-636 — ACTIVO: Próximo passe Full Stack
...
- **DEPENDENCIAS_RECEBIDAS**: CP-D5-635 publicado e sincronizado; passe Full Stack aprovado
...
Iniciar imediatamente o próximo passe Full Stack do CP-D5-636, sem aguardar confirmação verbal.
...
**Tarefa activa actual:** `CP-D5-636` — Acelerador de Mundo Full Stack: priorizar R1–R6 e desbloquear Dev2, Dev3 e Dev6 sem consulta passiva ou espera temporal.
