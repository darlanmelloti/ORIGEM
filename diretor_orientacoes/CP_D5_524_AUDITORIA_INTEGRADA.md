# CP-D5-524 — Auditoria integrada contínua R1–R6
...
O runtime completo está em `CP-D5-524_RUNTIME.log`. O checksum SHA-256 do relatório e do runtime será registado em `CP-D5-524_SHA256SUMS.txt`.
