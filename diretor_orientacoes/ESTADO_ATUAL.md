...
- **TAREFA_EM_EXECUCAO_AGORA**: Investigação de materiais/malhas importadas da Região 12 iniciada imediatamente após o commit `b42588f`, preservando a pulsação temporal.
...
- **ACTIVE_STATE**: `R12_MESH_MATERIAL_INVESTIGATION_IN_PROGRESS`
...
- **NEXT_STATE**: `R12_MESH_MATERIAL_VALIDATION`
