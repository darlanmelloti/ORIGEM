...
- **TAREFA_EM_EXECUCAO_AGORA**: Próximo passe da Região 12 iniciado imediatamente após o commit `fcb3512`: validação de estabilidade da rota e preparação do próximo refinamento visual.
...
- **ACTIVE_STATE**: `R12_POST_PERFORMANCE_PASS_IN_PROGRESS`
...
- **NEXT_STATE**: `R12_POST_PERFORMANCE_VALIDATION`
