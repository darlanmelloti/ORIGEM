...
| Dev3 Diretor cinematografico | Não possui branch própria. O módulo RegionalCinematicDirector existe na base e define Takes 1–7, mas não existe uma tomada mestre Casa Voss→12 Marcos. | Criar a especificação e a prova de uma tomada mestre, sem editar geometria fora do seu escopo. |
