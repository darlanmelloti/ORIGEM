# CP-D5-522 — Auditoria integrada contínua R1–R6
...
O runtime completo está em `CP-D5-522_RUNTIME.log`. O checksum SHA-256 do relatório e do runtime será registado em `CP-D5-522_SHA256SUMS.txt`.
