# CP-D5-516 — Auditoria integrada contínua R1–R6
...
O runtime completo está em `CP-D5-516_RUNTIME.log`. O checksum SHA-256 do relatório e do runtime está em `CP-D5-516_SHA256SUMS.txt`.
