# STATUS_CHECKPOINT_CP-D2-REGIAO12-050

## Escopo

Passe de rotação dos marcadores físicos da Região 12 — Cúpula Final. As Regiões 1–6 permanecem fora do escopo e não foram alteradas.
...
A evidência está em `diretor_orientacoes/evidence/cp-d2-continuity-region12-route-marker-rotation-final-pass/`. O findings está em `cp-d2-continuity-region12-route-marker-rotation-findings.md`.
