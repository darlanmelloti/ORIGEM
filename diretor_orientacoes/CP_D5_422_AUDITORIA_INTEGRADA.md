# CP-D5-422 — Auditoria integrada contínua R1–R6
...
Não foram observados `SCRIPT ERROR` ou `Parse Error`. Os avisos FSR1 são específicos do renderer OpenGL Compatibility headless. Evidência completa: `CP-D5-422_RUNTIME.log`.
