# CP-D5-521 — Regressão contínua da apresentação de Elias
...
O runtime completo está em `CP-D5-521_RUNTIME.log`. O checksum SHA-256 do relatório e do runtime será registado em `CP-D5-521_SHA256SUMS.txt`.
