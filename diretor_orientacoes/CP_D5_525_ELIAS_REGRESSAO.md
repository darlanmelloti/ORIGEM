# CP-D5-525 — Regressão contínua da apresentação de Elias
...
O runtime completo está em `CP-D5-525_RUNTIME.log`. O checksum SHA-256 do relatório e do runtime será registado em `CP-D5-525_SHA256SUMS.txt`.
