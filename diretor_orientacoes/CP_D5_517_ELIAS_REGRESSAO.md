# CP-D5-517 — Regressão contínua da apresentação de Elias
...
O runtime completo está em `CP-D5-517_RUNTIME.log`. O checksum SHA-256 do relatório e do runtime está em `CP-D5-517_SHA256SUMS.txt`.
