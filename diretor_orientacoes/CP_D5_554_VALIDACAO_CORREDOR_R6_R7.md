# CP-D5-554 — Validação do corredor modular R6→R7
...
O contrato está em `levels/dev5/R6R7HandoffContract.json` e o runtime completo está em `CP-D5-554_RUNTIME.log`. O checksum SHA-256 do contrato, relatório e runtime será registado em `CP-D5-554_SHA256SUMS.txt`.
