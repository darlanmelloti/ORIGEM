# STATUS_CHECKPOINT_CP-D2-REGIAO12-049
...
A evidência está em `diretor_orientacoes/evidence/cp-d2-continuity-region12-route-marker-longitudinal-final-pass/`. O findings está em `cp-d2-continuity-region12-route-marker-longitudinal-findings.md`.
