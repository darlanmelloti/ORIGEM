# CP-D5-383 — Auditoria contínua de orçamento LOD
...
A auditoria permanece compatível com GTX 1050 Ti. Os avisos FSR1 são específicos do renderer OpenGL Compatibility headless. Evidência completa: `CP-D5-383_RUNTIME.log`.
