...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-LATERAL-STILL-043
owner: Dev3
...
## Tarefa ativa — DEV3-R3-ARCH-LATERAL-STILL-043

A margem lateral do Arco deve manter uma **imobilidade material lateral sem reflexos**, limitada a materiais R3 já existentes e herdados de `r3_margin_silence_stillness`. A tarefa deve conservar apenas a ausência de reflexão lateral sem criar trilho, texto, UI, placas, objetos, geometria, luzes, emissão, VFX, áudio ou colisores; a rota R2→R4 deve permanecer aberta.
...
| Material | Actuar somente em materiais laterais existentes já marcados `r3_margin_silence_stillness`, sem criar trilho ou objectos novos |
...
`DEV3-R3-ARCH-LATERAL-STILL-043` preserva a margem lateral imóvel sem alterar o corredor.
