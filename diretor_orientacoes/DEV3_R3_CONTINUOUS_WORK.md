...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-MARGIN-CALM-028
owner: Dev3
...
## Tarefa ativa — DEV3-R3-ARCH-MARGIN-CALM-028

A margem lateral do Arco deve manter uma **calma material sem contraste residual**, limitada a materiais R3 já existentes e herdados de `r3_lateral_matte`. A tarefa deve conservar apenas a leitura lateral mate sem criar trilho, texto, UI, placas, objetos, geometria, luzes, emissão, VFX, áudio ou colisores; a rota R2→R4 deve permanecer aberta.
...
| Material | Actuar somente em materiais laterais existentes já marcados `r3_lateral_matte`, sem criar trilho ou objectos novos |
...
`DEV3-R3-ARCH-MARGIN-CALM-028` preserva a margem lateral calma sem alterar o corredor.
