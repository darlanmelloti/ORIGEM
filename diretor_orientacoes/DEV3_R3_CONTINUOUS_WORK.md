...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-LATERAL-STILL-069
owner: Dev3
...
## Tarefa ativa — DEV3-R3-ARCH-LATERAL-STILL-069
...
`DEV3-R3-ARCH-LATERAL-STILL-069` preserva a lateral imóvel sem reflexos e sem alterar o corredor.
