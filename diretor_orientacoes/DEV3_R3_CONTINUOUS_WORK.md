...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-LATERAL-CALM-071
owner: Dev3
...
## Entrega aprovada — DEV3-R3-ARCH-MARGIN-CALM-056
`R3CalmaMateDaMargem` preserva apenas materiais R3 já existentes, herdados de `r3_lateral_matte_silent`, com rugosidade máxima, metalicidade nula e emissão desligada. A camada não cria geometria, texto, UI, luz, emissão, VFX, áudio ou colisores. A prova `[ORIGEM_R3_ARCH_MARGIN_CALM_MATTE_OK]`, a captura visual, o parser e a porta R3 aprovaram a preservação do vão, da transição e das duas luzes locais; a entrega foi publicada em `683a58d`.
## Entrega aprovada — DEV3-R3-ARCH-LATERAL-STILL-057
`R3ImobilidadeMateLateral` preserva apenas materiais laterais R3 já existentes, herdados de `r3_margin_calm_matte`, com rugosidade máxima, metalicidade nula e emissão desligada. A camada não cria geometria, texto, UI, luz, emissão, VFX, áudio ou colisores. A prova `[ORIGEM_R3_ARCH_LATERAL_STILL_MATTE_OK]`, a captura visual, o parser e a porta R3 aprovaram a preservação do vão, da transição e das duas luzes locais; a entrega foi publicada em `3ab3aed`.
## Entrega aprovada — DEV3-R3-ARCH-MARGIN-REST-058
`R3RepousoMateDaMargem` preserva apenas materiais R3 já existentes, herdados de `r3_lateral_still_matte`, com rugosidade máxima, metalicidade nula e emissão desligada. A camada não cria geometria, texto, UI, luz, emissão, VFX, áudio ou colisores. A prova `[ORIGEM_R3_ARCH_MARGIN_REST_MATTE_OK]`, a captura visual, o parser e a porta R3 aprovaram a preservação do vão, da transição e das duas luzes locais; a entrega foi publicada em `34aa180`.
## Entrega aprovada — DEV3-R3-ARCH-LATERAL-CALM-059
`R3CalmaMateLateral` preserva apenas materiais laterais R3 já existentes, herdados de `r3_margin_rest_matte`, com rugosidade máxima, metalicidade nula e emissão desligada. A camada não cria geometria, texto, UI, luz, emissão, VFX, áudio ou colisores. A prova `[ORIGEM_R3_ARCH_LATERAL_CALM_MATTE_OK]`, a captura visual, o parser e a porta R3 aprovaram a preservação do vão, da transição e das duas luzes locais; a entrega foi publicada em `75280ba`.
## Entrega aprovada — DEV3-R3-ARCH-MARGIN-STILL-060
`R3ImobilidadeMateDaMargem060` preserva apenas materiais R3 já existentes, herdados de `r3_lateral_calm_matte`, com rugosidade máxima, metalicidade nula e emissão desligada. A camada não cria geometria, texto, UI, luz, emissão, VFX, áudio ou colisores. A prova `[ORIGEM_R3_ARCH_MARGIN_STILL_MATTE_OK]`, a captura visual, o parser e a porta R3 aprovaram a preservação do vão, da transição e das duas luzes locais; a entrega foi publicada em `9e3e657`.
## Entrega aprovada — DEV3-R3-ARCH-LATERAL-SILENCE-061
`R3SilencioMateLateral061` preserva apenas materiais laterais R3 já existentes, herdados de `r3_margin_still_matte`, com rugosidade máxima, metalicidade nula e emissão desligada. A camada não cria geometria, texto, UI, luz, emissão, VFX, áudio ou colisores. A prova `[ORIGEM_R3_ARCH_LATERAL_SILENCE_MATTE_OK]`, a captura visual, o parser e a porta R3 aprovaram a preservação do vão, da transição e das duas luzes locais; a entrega foi publicada em `1c414e2`.
## Entrega aprovada — DEV3-R3-ARCH-MARGIN-CALM-062
`R3CalmaMateDaMargem062` preserva apenas materiais R3 já existentes, herdados de `r3_lateral_silence_matte`, com rugosidade máxima, metalicidade nula e emissão desligada. A camada não cria geometria, texto, UI, luz, emissão, VFX, áudio ou colisores. A prova `[ORIGEM_R3_ARCH_MARGIN_CALM_MATTE_062_OK]`, a captura visual, o parser e a porta R3 aprovaram a preservação do vão, da transição e das duas luzes locais; a entrega foi publicada em `26099ec`.
## Entrega aprovada — DEV3-R3-ARCH-LATERAL-STILL-063
...
## Entrega aprovada — DEV3-R3-ARCH-MARGIN-CALM-068
`R3CalmaMateDaMargem068` preserva materiais R3 existentes herdados de `r3_lateral_silence_matte_067`, sem geometria, UI, luz, emissão, VFX, áudio ou colisores. A prova `[ORIGEM_R3_ARCH_MARGIN_CALM_MATTE_068_OK]`, captura, parser e porta R3 aprovaram a entrega reconciliada publicada em `280b069`.
## Entrega aprovada — DEV3-R3-ARCH-LATERAL-STILL-069
`R3ImobilidadeMateLateral069` preserva materiais R3 existentes herdados de `r3_margin_calm_matte_068`, sem geometria, UI, luz, emissão, VFX, áudio ou colisores. A prova `[ORIGEM_R3_ARCH_LATERAL_STILL_MATTE_069_OK]`, captura, parser e porta R3 aprovaram a entrega publicada em `51914f4` após rebase na integração.
## Entrega aprovada — DEV3-R3-ARCH-MARGIN-REST-070
`R3RepousoMateDaMargem070` preserva materiais R3 existentes herdados de `r3_lateral_still_matte_069`, sem geometria, UI, luz, emissão, VFX, áudio ou colisores. A prova `[ORIGEM_R3_ARCH_MARGIN_REST_MATTE_070_OK]`, captura, parser e porta R3 aprovaram a entrega publicada em `885ce14`.
## Tarefa ativa — DEV3-R3-ARCH-LATERAL-CALM-071
...
| Material | Actuar somente em materiais existentes já marcados `r3_lateral_still_matte_063`, sem criar trilho ou objectos novos |
...
| Verificação | Parser, `tools/qa/run_regional_gate.sh R3`, prova específica de repouso da margem e rotas R3 antes de publicar |
...
`DEV3-R3-ARCH-LATERAL-CALM-071` preserva a lateral calma sem reflexos e sem alterar o corredor.
