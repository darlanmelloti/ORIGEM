...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-MARGIN-STILL-060
owner: Dev3
...
## Tarefa ativa — DEV3-R3-ARCH-MARGIN-STILL-060
A margem do Arco deve manter uma **imobilidade material sem reflexos**, limitada a materiais R3 já existentes e herdados de `r3_lateral_calm_matte`. A tarefa conserva apenas a ausência de reflexão na margem sem criar trilho, texto, UI, placas, objetos, geometria, luzes, emissão, VFX, áudio ou colisores; a rota R2→R4 deve permanecer aberta.
...
| Material | Actuar somente em materiais existentes já marcados `r3_lateral_calm_matte`, sem criar trilho ou objectos novos |
...
| Verificação | Parser, `tools/qa/run_regional_gate.sh R3`, prova específica de imobilidade da margem e rotas R3 antes de publicar |
...
`DEV3-R3-ARCH-MARGIN-STILL-060` preserva a margem imóvel sem reflexos e sem alterar o corredor.
