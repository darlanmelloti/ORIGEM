...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-LATERAL-CALM-031
owner: Dev3
...
## Tarefa ativa — DEV3-R3-ARCH-LATERAL-CALM-031

A margem lateral do Arco deve manter uma **calma lateral estável e sem reflexos**, limitada a materiais R3 já existentes e herdados de `r3_margin_matte_rest`. A tarefa deve conservar apenas o acabamento lateral mate sem criar trilho, texto, UI, placas, objetos, geometria, luzes, emissão, VFX, áudio ou colisores; a rota R2→R4 deve permanecer aberta.
...
| Material | Actuar somente em materiais laterais existentes já marcados `r3_margin_matte_rest`, sem criar trilho ou objectos novos |
...
`DEV3-R3-ARCH-LATERAL-CALM-031` preserva a margem lateral calma sem alterar o corredor.
