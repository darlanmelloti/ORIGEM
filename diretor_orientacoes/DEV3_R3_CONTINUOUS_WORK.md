...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-MARGIN-CALM-052
owner: Dev3
...
| Material | Actuar somente em materiais existentes já marcados `r3_lateral_still_silent`, sem criar trilho ou objectos novos |
...
`DEV3-R3-ARCH-MARGIN-CALM-052` preserva a margem calma sem reflexos e sem alterar o corredor.
