...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-MARGIN-CALM-048
owner: Dev3
...
## Tarefa ativa — DEV3-R3-ARCH-MARGIN-CALM-048
A margem do Arco deve manter uma **calma material sem reflexos**, limitada a materiais R3 já existentes e herdados de `r3_lateral_matte_calm`. A tarefa conserva apenas a ausência de reflexão na margem sem criar trilho, texto, UI, placas, objetos, geometria, luzes, emissão, VFX, áudio ou colisores; a rota R2→R4 deve permanecer aberta.
...
| Material | Actuar somente em materiais existentes já marcados `r3_lateral_matte_calm`, sem criar trilho ou objectos novos |
...
`DEV3-R3-ARCH-MARGIN-CALM-048` preserva a margem calma sem reflexos e sem alterar o corredor.
