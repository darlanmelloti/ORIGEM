...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-MARGIN-CALM-036
owner: Dev3
...
## Tarefa ativa — DEV3-R3-ARCH-MARGIN-CALM-036

A margem lateral do Arco deve manter uma **calma material de margem sem contraste residual**, limitada a materiais R3 já existentes e herdados de `r3_lateral_matte_rest`. A tarefa deve conservar apenas a ausência de reflexão lateral sem criar trilho, texto, UI, placas, objetos, geometria, luzes, emissão, VFX, áudio ou colisores; a rota R2→R4 deve permanecer aberta.
...
| Material | Actuar somente em materiais laterais existentes já marcados `r3_lateral_matte_rest`, sem criar trilho ou objectos novos |
...
`DEV3-R3-ARCH-MARGIN-CALM-036` preserva a margem lateral calma sem alterar o corredor.
