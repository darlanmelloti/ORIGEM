...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-LATERAL-MATTE-047
owner: Dev3
...
## Tarefa ativa — DEV3-R3-ARCH-LATERAL-MATTE-047
A margem lateral do Arco deve manter um **acabamento material mate sem reflexos**, limitado a materiais R3 já existentes e herdados de `r3_margin_still_calm`. A tarefa conserva apenas a ausência de reflexão lateral sem criar trilho, texto, UI, placas, objetos, geometria, luzes, emissão, VFX, áudio ou colisores; a rota R2→R4 deve permanecer aberta.
...
| Material | Actuar somente em materiais laterais existentes já marcados `r3_margin_still_calm`, sem criar trilho ou objectos novos |
...
`DEV3-R3-ARCH-LATERAL-MATTE-047` preserva o acabamento lateral mate sem alterar o corredor.
