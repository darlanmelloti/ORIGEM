...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-MARGIN-REST-034
owner: Dev3
...
## Tarefa ativa — DEV3-R3-ARCH-MARGIN-REST-034

A margem lateral do Arco deve manter um **repouso material de margem sem reflexão residual**, limitado a materiais R3 já existentes e herdados de `r3_lateral_still_rest`. A tarefa deve conservar apenas o acabamento lateral mate sem criar trilho, texto, UI, placas, objetos, geometria, luzes, emissão, VFX, áudio ou colisores; a rota R2→R4 deve permanecer aberta.
...
| Material | Actuar somente em materiais laterais existentes já marcados `r3_lateral_still_rest`, sem criar trilho ou objectos novos |
...
`DEV3-R3-ARCH-MARGIN-REST-034` preserva a margem lateral em repouso sem alterar o corredor.
