...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-LATERAL-STILL-051
owner: Dev3
...
## Tarefa ativa — DEV3-R3-ARCH-LATERAL-STILL-051
A margem lateral do Arco deve manter uma **imobilidade material sem reflexos**, limitada a materiais R3 já existentes e herdados de `r3_margin_rest_silent`. A tarefa conserva apenas a ausência de reflexão lateral sem criar trilho, texto, UI, placas, objetos, geometria, luzes, emissão, VFX, áudio ou colisores; a rota R2→R4 deve permanecer aberta.
...
| Material | Actuar somente em materiais laterais existentes já marcados `r3_margin_rest_silent`, sem criar trilho ou objectos novos |
...
`DEV3-R3-ARCH-LATERAL-STILL-051` preserva a margem lateral imóvel sem reflexos e sem alterar o corredor.
