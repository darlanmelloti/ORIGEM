...
```text
status: ACTIVE
task_id: DEV3-R3-ARCH-MARGIN-STILL-038
owner: Dev3
...
| Material | Actuar somente em materiais laterais existentes já marcados `r3_lateral_silence_rest`, sem criar trilho ou objectos novos |
...
`DEV3-R3-ARCH-MARGIN-STILL-038` preserva a margem lateral imóvel sem alterar o corredor.
