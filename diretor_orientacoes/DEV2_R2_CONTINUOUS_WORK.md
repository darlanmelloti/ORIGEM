...
```text
status: ACTIVE
task_id: DEV2-R2-RIVER-RIVERBANK-065
owner: Dev2
...
## Tarefa ativa — DEV2-R2-RIVER-RIVERBANK-065
...
A fila seguinte será definida após a aprovação de `DEV2-R2-RIVER-RIVERBANK-065`, mantendo o estado `ACTIVE` e o trabalho contínuo rastreável no GitHub.
