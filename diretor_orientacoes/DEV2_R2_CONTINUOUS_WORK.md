...
## Tarefa ativa — DEV2-R2-RIVER-QA-027

O verificador contratual da R2 deve confirmar a **correspondência entre âncoras cartográficas e pontos físicos**, preservando a entrada da Estrada do Rio e a saída no Arco dentro do corredor declarado. Esta tarefa é somente de QA e não altera geometria, navegação ou cenas.
...
| Acesso | Confirmar entrada e saída cartográficas convertidas em pontos físicos internos |
...
| Verificação | Executar o verificador contratual e acrescentar `[ORIGEM_R2_RIVER_QA_027_OK]` antes de abrir PR |
...
A fila seguinte será definida após a aprovação de `DEV2-R2-RIVER-QA-027`, mantendo o estado `ACTIVE` e o trabalho contínuo rastreável no GitHub.
